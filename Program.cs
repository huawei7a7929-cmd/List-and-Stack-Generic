...
//Ця програма дозволяє користувачу вводити вік своїх тварин і зберігає ці значення у списку (List<float>).
//Користувач вводить дані доти, поки не напише exit, після чого програма виводить вік усіх тварин.
//Далі обчислюється та виводиться середній вік тварин.
//Для коректного введення дробових чисел використовується відповідна культура.
